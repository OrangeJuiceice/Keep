...
export default {
  ...
  onLoad() {
    ...
    if (uni.getStorageSync("timer2")) {
      this.groups = uni.getStorageSync("timer2")[0];
      this.times = uni.getStorageSync("timer2")[1];
      this.rest = uni.getStorageSync("timer2")[2];
    }
  ...
  methods: {
    bindTimeChange(e) {
      ...
      uni.setStorageSync("timer2", [this.groups, this.times, this.rest]);
    },
    countDown() {
      this.times--;
      ...
      if (this.times <= 0 && this.groups == 1) {
        ...
        // 单词运动时间
        var seconds =
          uni.getStorageSync("timer2")[0] * uni.getStorageSync("timer2")[1] * 2;
        ...
        uni.showModal({
          ...
          success: function (res) {
            if (res.confirm) {
              console.log("用户点击确定");
              uni.navigateTo({
                url: "/pages/edit/index?move=哑铃肩部推举&time=" + time,
              });
            } else if (res.cancel) {
              console.log("用户点击取消");
            }
            ...
            var total =
              ...
              parseInt(uni.getStorageSync("timer2")[0]) *
                parseInt(uni.getStorageSync("timer2")[1]) *
                2;
